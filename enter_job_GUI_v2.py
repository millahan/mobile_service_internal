#Hannah Millward
#August 2022
#Combining EnterJob interface with distance, WOF, and vrisuc calculations
...
class EnterJob:
    ...
    def calc_cost(self,partner):
        ...
        self.jobs_info = []
        self.jobs_info.append(job_number)
        self.jobs_info.append(customer_name)
        self.jobs_info.append(cost)
        print(f"Job number: {self.jobs_info[0]}, Customer Name: {self.jobs_info[1]}, Total Cost: {self.jobs_info[2]}")
